...
document
  .getElementById('memory1-option')
  .addEventListener('click', function () {
    changePrice('memory', 0);
  });
document
  .getElementById('memory2-option')
  .addEventListener('click', function () {
    changePrice('memory', 180);
  });
// change price for storage
document
  .getElementById('storage1-option')
  .addEventListener('click', function () {
    changePrice('storage', 0);
  });
document
  .getElementById('storage2-option')
  .addEventListener('click', function () {
    changePrice('storage', 100);
  });
document
  .getElementById('storage3-option')
  .addEventListener('click', function () {
    changePrice('storage', 180);
  });
// change price for delivery
document
  .getElementById('delivery1-option')
  .addEventListener('click', function () {
    changePrice('delivery', 0);
  });
document
  .getElementById('delivery2-option')
  .addEventListener('click', function () {
...
document.getElementById('cupon-btn').addEventListener('click', function () {
  ...
  if (cuponValue == 'stevekaku') {
    ...
    console.log(alert('Cupon does not match !'));
  }
  cuponInput.value = '';
});
